...
const HomeView = ({ navigation }: any): JSX.Element => {
    ...
    const tasks = [
        { projectName: "Project1", name: "test", deadline: "07/01/2023" },
        { projectName: "Project1", name: "test", deadline: "07/01/2023" },
        { projectName: "Project1", name: "test", deadline: "07/01/2023" }]
    return (
        <MainScreen options={{
            ...
            <FlatList
                ...
                renderItem={({ item }) => {
                    if (item == 1) {
                        return (
                            <View style={[globalStyles.card, homeStyles.addCard, { backgroundColor: surfaceColor }]}>
                        ...
                        return (
                            <View style={[globalStyles.card, { backgroundColor: surfaceColor, padding: 0, alignItems: 'center' }]}>
            ...
            <View style={{marginBottom: 24}}>
                {
                    tasks.map((item,index) => {
                        return (
                            <View key={index} style={[globalStyles.card, { backgroundColor: surfaceColor, elevation: 4, marginTop: 32, marginBottom: 0 }]}>
